                ...
                <tr>
                    ...
                    <td class="password-cell">
                        <div class="password-field">
                            <input type="password" id="password<?= $problemaV->idUsuario ?>" value='<?= htmlspecialchars($problemaV->password) ?>' readonly>
                    ...
                    <td>
                        <form method="POST" action="" id="formEliminar<?= $problemaV->idUsuario ?>">
                            ...
                            <input type="button" value="Eliminar" class="btn btn-danger" onclick="confirmarEliminacion(<?= $problemaV->idUsuario ?>)">
                        </form>
                    </td>
                </tr>
                <?php
